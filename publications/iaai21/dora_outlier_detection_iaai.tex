...
% targets in $D_{s+}$.
\todo{Consider merging all three data set discussions since they are
...
all \num{58} target images in $D_{1694-1703}$. \todo{Explain MDR the first
time it appears. }
...
AUC. \todo{For completeness, Explain why no LRX here.}
...
\begin{table}
  ...
  \begin{tabular}{l|ccc}
    \hline
    Algorithm & Astrophysics & Earth & Planetary \\
    \hline
    PCA               & & 0.41 & 0.44 \\
    DEMUD             & & 0.41 & 0.44 \\
    \hline
