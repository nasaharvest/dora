...
\paragraph{Algorithm performance.} There was no one algorithm that 
consistently had the best performance across all four datasets. PCA had
the best performance overall for the astrophysics and F-MNIST datasets, 
while negative sampling and isolation forest had the best performance for
the Earth science and planetary datasets respectively. [This shows why
it is best for us to include a variety of algorithms because the best 
algorithm will vary depending on the dataset.] The purpose of this study
was to demonstrate how DORA could be used to facilitate comprehensive
...
practice and sense and leave hyperparameter tuning, which would likely 
