...
performance of each ranking algorithm for a variety of scientific domains
 ...
 benchmark dataset that uses MNIST and Fashion-MNIST. Here we describe
...
traditional benchmark dataset. In this experiment, we used 60,000 images from 
...
For the MNIST and F-MNIST dataset, PCA and DEMUD tied for the highest precision,
